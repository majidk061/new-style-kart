...
<?php $__env->startSection('container'); ?>
    ...
    <p class="text-center alert alert-danger">
     Your Error Code is: <?php echo e($error); ?>. Development Environment Configuration Issue. Please search that error code on internet to find out the reason and fixed it before installation.
    </p>
    <?php endif; ?>
    <p class="text-center">
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/adminpanel/resources/views/vendor/installer/error.blade.php ENDPATH**/ ?>