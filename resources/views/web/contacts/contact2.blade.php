            ...
            <div class="row">
              <div class="col-6">
                  ...
                  <ul class="contact-logo pl-0 mb-0">
                    ...
                    <li> <i class="fas fa-tty"></i><br>@lang('website.FAX')</li>
                  </ul>
              </div>  
              <div class="col-6 right">
                <ul class="contact-info  pl-0 mb-0">
                  <li><font>
                    <a href="#"><br>{{$result['commonContent']['setting'][11]->value}}</a>
                  </font> </li>
                  ...
                  <li><font><a href="#"><br>{{$result['commonContent']['setting'][11]->value}}</a> </font></li>
                </ul>
              </div>  
            </div>
